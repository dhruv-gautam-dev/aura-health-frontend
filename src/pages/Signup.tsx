...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      navigate(role === "patient" ? "/OnboardingPatient" : "/OnboardingDoctor");
    } catch (error: any) {
      toast({
      ...
      <div className="hidden lg:flex flex-col justify-center p-12 bg-[#13B7A2] relative overflow-hidden text-white">
        ...
        >
          ...
          <p className="text-xl opacity-80 max-w-md leading-relaxed">
            Manage your health records, connect with doctors, and get AI-powered health insights.
          </p>
        </motion.div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                <Button variant="outline" className="h-12 rounded-xl gap-2" type="button" onClick={handleGoogleSignup}>
              ...
              <p className="text-center text-sm text-muted-foreground mt-8">
                ...
                <Link to="/login" className="text-[#13B7A2] font-bold hover:underline">
                  Sign In
                </Link>
              </p>
            </form>
